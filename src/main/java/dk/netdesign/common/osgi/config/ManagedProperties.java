...
/**
 * The ManagedProperties class is used as a simple setup mechanism for the
...
public class ManagedProperties implements Map<String, Object>, ManagedService, MetaTypeProvider, ConfigurationCallbackHandler {
     ...
     *
     * @param name The name of the properties. This is used to create the name
     * for the MetaData service.
     * @param id This is the PID used to specify the path for the configuration
     * file in the Configuration Admin service.
     ...
     * Create a ManagedProperties object
     *
     * @param defaults This map is used to specify a default set of properties,
     * which can be used if no data is returned from the Configuration Admin.
     * @param name The name of the properties. This is used to create the name
     * for the MetaData service.
     * @param id This is the PID used to specify the path for the configuration
     * file in the Configuration Admin service.
     ...
     * @param description This is used to specify the Description for the bundle
     * for the MetaData service.
     * @param configuredClass This is used to generate the PID used to specify
     * the path for the configuration file in the Configuration Admin service.
     */
     ...
     *
     * @param context The context in which to register this ManagedProperties
     * object.
     */
     ...
     *
     * @param context The context in which to unregister this ManagedProperties
     * object.
     */
    ...
    /**
     * In case that some components in the service needs to be notified of a
     * change in configuration, it can register an instance of
     * ConfigurationCallback. Whenever the configuration in this
     * ManagedProperties object is updated, the configurationUpdated method of
     * the ConfigurationCallback is called.
     *
